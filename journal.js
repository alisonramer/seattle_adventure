...
firstPlaceText.textContent = 'First '+userName+' went to ' +placeNamesArray[placesGone[0]]+'!';
secondPlaceText.textContent = 'Then '+userName+' went to ' +placeNamesArray[placesGone[1]]+'!';
thirdPlaceText.textContent = 'Finally ' +userName+' went to ' +placeNamesArray[placesGone[2]]+'!';
